...
/*
            ...
            11 replaceAll bir grubu degistirir. regex koyabiliriz.
            12)trim sadece basdaki ve sondaki boslugu siler
     */
         /* Regular Expression(regex) : Belli turdeki characterleri secebilmemize yarar.
		 1) \\d    ==> tum rakamlar digit(basamak'hane)
		  	 \\D    ==> tum rakam disi character ler
		 2) \\w   ==> A->Z		a->z			0->9    _tum buyuk, kucuk harf ve rakamlar dahil
    ...
    public static void main(String[] args) {
       ...
       Scanner input2 = new Scanner(System.in);
        ...
        String tamIsim=isim.concat(" "+soyAd).toUpperCase();//Concat metodu
    ...
    String exp="Learn Java Earn 000 Money";
    int retur=exp.replaceAll( "[0-9]",
            "").replaceAll(" ","").replaceAll("\\p{Punct}","").length();
