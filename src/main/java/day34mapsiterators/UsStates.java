...
/*    "enum"--> bir data deposudur
            --> sabit dataları App(aplicationun) içine gömmek için "enum" kullanırız
            App'ler "standalone" (kendi basına ayakta durabilmesi icin) olmasi gerektigi icin sabit
            datalari app'nin icine gomeriz
            --> icine sabit degisme ihtimali olmayan dataları koyarız
            haftanın günleri,yılın ayları gibi
            --> kullandığımız data yı renklendirir mesela "arizona"yi baska
            bir classta kullandıgım icin renklendirdi          */
...
public enum UsStates {
    ...
    UsStates(String stateName, String abbreviation, String capital){ //bu consructoru kullanarak obje üreteceğim
        this.stateName = stateName;
        this.abbreviation = abbreviation;
        this.capital = capital;
    }
    /* variableleri "private" yaptım ama bunlerın icine giren degerleri okumam lazım
    dolayısıyla "get"leri kullanmam lazim*/

    public String getStateName() {    // sag tıkla->generate-> get-> hepsi-> enter
        return stateName;             // "final" yaptigim icin "set" kullanmıyorum degistiremem cunku
