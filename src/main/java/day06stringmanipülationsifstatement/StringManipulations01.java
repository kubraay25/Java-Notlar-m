package day06stringmanipülationsifstatement;

public class StringManipulations01 {
    public static void main(String[] args){
        //Example1: Bir Stringin baş ve sonunda space caharecter'i varsa siliniz,
        //          "  Ali Can  "   ==> "Ali Can"
        String s = "  Ali Can  ";
        System.out.println(s);//

        //trim() methodu bir Stringin bas ve sonundaki space character'lerini siler, aradaki spacelere dokunmaz
        ...
        Double totalPrice = Double.valueOf(tv2)+ Double.valueOf(laptop2);//875.99
        ...
        char secont =name.trim().toUpperCase().split(" ")[1].charAt(0);
        System.out.println(secont);//C

        System.out.println(""+first+secont);//AC
        ...
        //2.Yol: isEmpty() kullan, Java bir konuda method üretmişse, o method'u kullanmak en iyisidir
